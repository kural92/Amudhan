...
public class payMentPrice extends BaseTest
{
	...
	public void paymentTestPrice() throws InterruptedException, Throwable {
		...
		BaseTest.typeData(g.getMatriID(), less40);
...
///////////////////////////////////		
		if (ilessthan40D6==(Diamon6m)) {
			System.err.println("Listed Value is matched with Diamond 6mnth "+lessthan40D6);
		}else {
		//	System.out.println("Listed Value is not matched with Diamond 6mnth "+lessthan40D6);
		}
		
		if (ilessthan40D6==(Diamon6mDis)) {
			System.err.println("Listed Value is matched with Diamond 6mnth_DIS "+lessthan40D6);
		} else {
		//	System.out.println("Listed Value is not matched with Diamond 6mnth_DIS "+lessthan40D6);
		}
/////			
		
		if (ilessthan40D3==(Diamond3m)) {
			System.err.println("Listed Value is matched with Diamond 3mnth "+lessthan40D3);
		}else {
	//		System.out.println("Listed Value is not matched with Diamond 3mnth "+lessthan40D3);
		}
		
		if (ilessthan40D6==(Diamond3mDis)) {
			System.err.println("Listed Value is matched with Diamond 3mnth_DIS "+lessthan40D3);
		} else {
	//		System.out.println("Listed Value is not matched with Diamond 3mnth_DIS "+lessthan40D3);
		}
/////////////		
		
		if (ilessthan40P3==(Platinum3m)) {
			System.err.println("Listed Value is matched with Platinum 3mnth "+lessthan40P3);
		}else {
	//		System.out.println("Listed Value is not matched with Platinum 3mnth "+lessthan40P3);
		}
		if (ilessthan40P3==(Platinum3mDis)) {
			System.err.println("Listed Value is matched with Platinum 3mnth_DIS "+lessthan40P3);
		} else {
	//		System.out.println("Listed Value is not matched with Platinum 3mnth_DIS "+lessthan40P3);
		}
