...
public class R1PG extends BaseTest{
...
int Gold3m, Gold6m, Diamond3m, Diamon6m, Platinum3m, Platinum6m, TillYouMarry,Gold3mDis, Gold6mDis, Diamond3mDis, Diamon6mDis, Platinum3mDis, Platinum6mDis, TillYouMarryDis;
	...
	public void paymentTestPrice() throws InterruptedException, Throwable {
		...
		BaseTest.typeData(g.getMatriID(), R1PG);
...
///////////////////////////////////		
		if (iR1PGD6==(Diamon6m)) {
			System.err.println("Listed Value is matched with Diamond 6mnth "+R1PGD6);
		}else {
	//		System.out.println("Listed Value is not matched with Diamond 6mnth "+R1PGD6);
		}
		
		if (iR1PGD6==(Diamon6mDis)) {
			System.err.println("Listed Value is matched with Diamond 6mnth_DIS "+R1PGD6);
		} else {
	//		System.out.println("Listed Value is not matched with Diamond 6mnth_DIS "+R1PGD6);
		}
/////			
		
		if (iR1PGD3==(Diamond3m)) {
			System.err.println("Listed Value is matched with Diamond 3mnth "+R1PGD3);
		}else {
	//		System.out.println("Listed Value is not matched with Diamond 3mnth "+R1PGD3);
		}
		
		if (iR1PGD3==(Diamond3mDis)) {
			System.err.println("Listed Value is matched with Diamond 3mnth_DIS "+R1PGD3);
		} else {
	//		System.out.println("Listed Value is not matched with Diamond 3mnth_DIS "+R1PGD3);
		}
/////////////		
		
		if (iR1PGP3==(Platinum3m)) {
			System.err.println("Listed Value is matched with Platinum 3mnth "+R1PGP3);
		}else {
	//		System.out.println("Listed Value is not matched with Platinum 3mnth "+R1PGP3);
		}
		if (iR1PGP3==(Platinum3mDis)) {
			System.err.println("Listed Value is matched with Platinum 3mnth_DIS "+R1PGP3);
		} else {
	//		System.out.println("Listed Value is not matched with Platinum 3mnth_DIS "+R1PGP3);
		}
