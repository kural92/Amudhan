...
public class UserSet extends BaseTest{
	...
	@Test
	private void userSetTest() throws Throwable {
	...
	///	 driver.findElement((By.xpath("//*[@id=\"topnav-login-menu\"]/div[2]/div[4]/a")).click();
		...
		for (int j = 1; j<=c; j++) {
			...
			for (int j2 = 0; j2 <=9; j2++) {
				...
				String Eat = driver.findElement(By.xpath("(//span[contains(text(),'Eating Habits')]//following::span[2])[1]")).getText();
				System.out.println("Eating Habits are : "+ Eat);
				
				String Smoke = driver.findElement(By.xpath("(//span[contains(text(),'Smoking Habits')]//following::span[2])[1]")).getText();
				System.out.println("Smoking Habits are : "+ Smoke);
				
				String Drink = driver.findElement(By.xpath("(//span[contains(text(),'Drinking Habits')]//following::span[2])[1]")).getText();
				System.out.println("Drinking Habits are : "+ Drink);
				
				/*
				 * Thread.sleep(2000); if (habit.contains("Vegetarian")) {
				 * System.out.println("Eating Habit was "+ habit); } else {
