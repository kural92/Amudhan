...
public class PayR2 extends BaseTest {
...
int Gold3m, Gold6m, Diamond3m, Diamon6m, Platinum3m, Platinum6m, TillYouMarry,Gold3mDis, Gold6mDis, Diamond3mDis, Diamon6mDis, Platinum3mDis, Platinum6mDis, TillYouMarryDis;
	...
	public void paymentTestPrice() throws InterruptedException, Throwable {
		...
		BaseTest.typeData(g.getMatriID(), R2);
...
///////////////////////////////////		
		if (iR2D6==(Diamon6m)) {
			System.err.println("Listed Value is matched with Diamond 6mnth "+R2D6);
		}else {
	//		System.out.println("Listed Value is not matched with Diamond 6mnth "+R2D6);
		}
		
		if (iR2D6==(Diamon6mDis)) {
			System.err.println("Listed Value is matched with Diamond 6mnth_DIS "+R2D6);
		} else {
	//		System.out.println("Listed Value is not matched with Diamond 6mnth_DIS "+R2D6);
		}
/////			
		
		if (iR2D3==(Diamond3m)) {
			System.err.println("Listed Value is matched with Diamond 3mnth "+R2D3);
		}else {
	//		System.out.println("Listed Value is not matched with Diamond 3mnth "+R2D3);
		}
		
		if (iR2D3==(Diamond3mDis)) {
			System.err.println("Listed Value is matched with Diamond 3mnth_DIS "+R2D3);
		} else {
	//		System.out.println("Listed Value is not matched with Diamond 3mnth_DIS "+R2D3);
		}
/////////////		
		
		if (iR2P3==(Platinum3m)) {
			System.err.println("Listed Value is matched with Platinum 3mnth "+R2P3);
		}else {
	//		System.out.println("Listed Value is not matched with Platinum 3mnth "+R2P3);
		}
		if (iR2P3==(Platinum3mDis)) {
			System.err.println("Listed Value is matched with Platinum 3mnth_DIS "+R2P3);
		} else {
	//		System.out.println("Listed Value is not matched with Platinum 3mnth_DIS "+R2P3);
		}
