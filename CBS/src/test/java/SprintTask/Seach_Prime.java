...
public class Seach_Prime extends BaseTest{
	...
	//	Thread.sleep(3000);
		Thread.sleep(3000);
		acc.moveToElement(driver.findElement(By.xpath("//a[contains(text(),'Search')]"))).build().perform();
	...
	//	acc.moveToElement(driver.findElement(By.xpath("//a[contains(text(),'Matches ')]"))).build().perform();
		...
		Thread.sleep(3000);
		acc.moveToElement(driver.findElement(By.xpath("//a[contains(text(),'Search')]"))).click().build().perform();
	...
	//	int Count = (int) Math.ceil(Coun);
		...
		for (int j = 1; j <=Coun; j++) {
			...
			try {
			//	 ID= driver.findElement(By.xpath("(//span[@id='oppositeMemberId'])["+j+"]")).getText();
			//	System.out.println(ID);
					
			} catch (Exception e) {
				
			//	 ID= driver.findElement(By.xpath("(//input[@id='oppmemberMatriId'])["+(j-1)+"]")).getText();
			//	System.out.println(ID);
			}
			Thread.sleep(6000);
	 	
			
		String Prime1 = "Non Prime";
		try {
			Thread.sleep(3000);
			 Prime1 = driver.findElement(By.xpath("//span[contains(text(),'PRIME')]")).getText();
		//	System.out.println(Prime);
			...
			/*
			 * String Edu = null; if (Prime1.equals("Prime")) {
			 * 
			 * Thread.sleep(3000); Edu = driver.findElement(By.
			 * xpath("(//div[@class='edu-cap-icon padb10 font12 ng-scope'])["+j+"]")).
			 * getText();
			 * 
			 * } else {
			 * 
			 * System.err.println(ID+" : Not an Prime Member"); }
			 */
		...
		System.err.println(ID+" : "+ Prime1+" : "+Edu);	
