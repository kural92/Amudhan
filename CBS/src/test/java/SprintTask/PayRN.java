...
public class PayRN extends BaseTest{
...
int Gold3m, Gold6m, Diamond3m, Diamon6m, Platinum3m, Platinum6m, TillYouMarry,Gold3mDis, Gold6mDis, Diamond3mDis, Diamon6mDis, Platinum3mDis, Platinum6mDis, TillYouMarryDis;
	...
	public void paymentTestPrice() throws InterruptedException, Throwable {
		...
		BaseTest.typeData(g.getMatriID(), RN);
...
///////////////////////////////////		RND6
		if (iRND6==Diamon6m) {
			System.err.println("Listed Value is matched with Diamond 6mnth "+RND6);
		}else {
		//	System.out.println("Listed Value is not matched with Diamond 6mnth "+RND6);
		}
		
		if (iRND6==(Diamon6mDis)) {
			System.err.println("Listed Value is matched with Diamond 6mnth_DIS "+RND6);
		} else {
		//	System.out.println("Listed Value is not matched with Diamond 6mnth_DIS "+RND6);
		}
/////			
		
		if (iRND3==(Diamond3m)) {
			System.err.println("Listed Value is matched with Diamond 3mnth "+RND3);
		}else {
		//	System.out.println("Listed Value is not matched with Diamond 3mnth "+RND3);
		}
		
		if (iRND3==(Diamond3mDis)) {
			System.err.println("Listed Value is matched with Diamond 3mnth_DIS "+RND3);
		} else {
		//	System.out.println("Listed Value is not matched with Diamond 3mnth_DIS "+RND3);
		}
/////////////		
		
		if (iRNP3==(Platinum3m)) {
			System.err.println("Listed Value is matched with Platinum 3mnth "+RNP3);
		}else {
		//	System.out.println("Listed Value is not matched with Platinum 3mnth "+RNP3);
		}
		if (iRNP3==(Platinum3mDis)) {
			System.err.println("Listed Value is matched with Platinum 3mnth_DIS "+RNP3);
		} else {
	//		System.out.println("Listed Value is not matched with Platinum 3mnth_DIS "+RNP3);
		}
