...
//	BaseTest.click(driver.findElement(By.id("dobYear")));
	 ...
	 * BaseTest.select_index(driver.findElement(By.id("religion")), 1); } catch
	...
	Thread.sleep(3000);
	try {
		BaseTest.select_index(driver.findElement(By.id("denomination")), 1);
	} catch (Exception e) {
...
/*	Thread.sleep(3000);
	...
	Thread.sleep(2000);
	for (int i = 1; i <= CommonDivision_Count; i++) {
		Thread.sleep(2000);
		String Coomon_Division = BaseTest.getExcelData("Common Division", i, 1);
...
/*	Thread.sleep(3000);
	...
	*/
	...
	Thread.sleep(3000);
	try {
		BaseTest.select_index(driver.findElement(By.id("subCaste")), 1);
		Thread.sleep(2000);
	...
	Thread.sleep(5000);
	driver.findElement(By.id("email")).sendKeys("amukural"+Math.random()*1+"@gmail.com");
	...
	Thread.sleep(3000);
	BaseTest.select_index(driver.findElement(By.id("residingState")), 12);
	
	
	Thread.sleep(3000);
	BaseTest.select_index(driver.findElement(By.id("residingCityMainDistId")), 7);
	...
	try {  String Dosham = BaseTest.getExcelData("Registeration", 1, 20);
	  Thread.sleep(3000); 
...
//	}	
	...
	/*	  try {      Thread.sleep(2000);
		  ...
		  Thread.sleep(3000);
 	   			...
 	   			for (int j = 1; j <43; j++) {
 	   				...
 	   				Thread.sleep(2000);
 	   				WebElement Caste_aa = driver.findElement(By.id("partnerCaste"));
 	   				...
 	   				Thread.sleep(2000);
 	   				if (Coomon_Division.contains(Caste_Value)) {
 	   					System.out.println(Coomon_Division+" matches with Onboarding PP given data "+Caste_Value);
 	   				} else {
 	   					System.err.println(Coomon_Division+" not matches with onboarding PP given data "+Caste_Value);
 	   				}
 	   		   		...
 	   		   		for (int i = 2; i < 10; i++) {
 	   		   			...
 	   		   			for (int j = 1; j <43; j++) {
 	   		   				...
 	   		   				if (Coomon_Division.contains(Caste_Value)) {
 	   		   					...
 	   		   					System.err.println(Coomon_Division+" not matches with Onboarding PP WCSM given data "+Caste_Value);
 	   		   				}
	...
	////////////////////////////////////////////////////////////////////////////////////
     ...
     try {           Thread.sleep(5000);
		...
		//	driver.navigate().to("https://www."+CommunitySite+".com/profiledetail/index.php?act=fullprofilenew&id="+matriid);
         ...
         /////////////////////////////////////////
     		        Thread.sleep(2000);
     		        try {//*[@id="topnav-login-menu"]/div[3]/div[2]/div[1]/a
		        ...
		        Thread.sleep(5000);
		        try {
		         Caste_PP = driver.findElement(By.xpath("//span[contains(text(),'Division')]//following::span[1]")).getText();
                System.out.println(Caste_PP);  } catch (Exception e) {
					// TODO: handle exception
				}
 ...
 /////////////////////////////////////////////////////          
           try {
			if (Caste_PP.contains("Any")) {
				System.out.println("Division was any as per Requirement");
			} else {
...
////////////////////////////////////////////////////////////
           ...
           try {
				acc.moveToElement(driver.findElement(By.xpath("//*[@id=\"topnav-login-menu\"]/div[3]/div[2]/div[1]/a"))).build().perform();
				Thread.sleep(3000);
	        	acc.moveToElement(driver.findElement(By.xpath("//a[contains(text(),'Privacy Settings')]"))).click().build().perform();
			} catch (Exception e) {
				acc.moveToElement(driver.findElement(By.xpath("//*[@id=\"topnav-login-menu\"]/div[3]/div[2]/div[1]/a/img"))).build().perform();
				Thread.sleep(3000);
	        	acc.moveToElement(driver.findElement(By.xpath("//a[contains(text(),'Privacy Settings')]"))).click().build().perform();
           ...
           Thread.sleep(3000);
           if (!driver.findElement(By.id("wcsmstatus2")).isSelected()) {
        	   Thread.sleep(2000);
        	   driver.findElement(By.id("wcsmstatus2")).click();
			
		}else { }
           
           
           Thread.sleep(3000);
           driver.findElement(By.xpath("//div[contains(text(),'More Preferences')]")).click();
           
           
           Thread.sleep(3000);
           WebElement Division_aa = driver.findElement(By.id("wcsmCaste"));
   		Select aa = new Select(Division_aa);
   		WebElement Division_Val = aa.getFirstSelectedOption();
   		 subCaste_Value = Division_Val.getText();
   		System.out.println("Division Value : "+ subCaste_Value);
   		
   	 //wcsmDenomination    //wcsmCaste
   		if (subCaste_Value.contains("Any")) {
			System.out.println("WCSM Division Value was Any as per Requirement");
		} else {
   	...
   	/*	int Denomination_Count = BaseTest.getCellCount("Common Division");
   		...
   		for (int i = 2; i < Denomination_Count; i++) {
   			...
   			Thread.sleep(2000);
   			BaseTest.select_text(driver.findElement(By.id("wcsmDenomination")), Denomination);
   		...
   		*/	
   			...
   			for (int j = 1; j <43; j++) {
   				...
   				Thread.sleep(2000);
   				WebElement Caste_aa = driver.findElement(By.id("wcsmCaste"));
   				Select aa1 = new Select(Caste_aa);
   				WebElement Caste_Val = aa1.getFirstSelectedOption();
   				 Caste_Value = Caste_Val.getText();
   				System.out.println("Caste Value : "+ Caste_Value);
   				...
   				Thread.sleep(2000);
   				if (Coomon_Division.contains(Caste_Value)) {
   					System.out.println(Coomon_Division+" matches with WCSM given data "+Caste_Value);
   				} else {
   					System.err.println(Coomon_Division+" not matches with WCSM given data "+Caste_Value);
   				}
...
//////////////////////
   	   		...
   	   		//	int CommonDivision_Count = BaseTest.getRowCount("Common Division");
   	   			...
   	   			for (int j = 1; j <43; j++) {
   	   				...
   	   				Thread.sleep(2000);
   	   				WebElement Caste_aa = driver.findElement(By.id("casteDivision"));
   	   				Select aa1 = new Select(Caste_aa);
   	   				WebElement Caste_Val = aa1.getFirstSelectedOption();
   	   				 Caste_Value = Caste_Val.getText();
   	   				System.out.println("Caste Value : "+ Caste_Value);
   	   				...
   	   				Thread.sleep(2000);
   	   				if (Coomon_Division.contains(Caste_Value)) {
   	   					System.out.println(Coomon_Division+" matches with PP given data "+Caste_Value);
   	   				} else {
   	   					System.err.println(Coomon_Division+" not matches with PP given data "+Caste_Value);
   	   				}
   	   		   		...
   	   		   		for (int i = 2; i < 10; i++) {
   	   		   			...
   	   		   			for (int j = 1; j <43; j++) {
   	   		   				...
   	   		   				if (Coomon_Division.contains(Caste_Value)) {
   	   		   					...
   	   		   					System.err.println(Coomon_Division+" not matches PP WCSM given data "+Caste_Value);
   	   		   				}
		...
		Thread.sleep(2000);
  			for (int j = 1; j <43; j++) {
  				...
  				int cc = (j+1);
	   				...
	   				//BaseTest.select_index(driver.findElement(By.id("casteDivision")), j);
	   				String search_divison = driver.findElement(By.xpath("//select[@id='casteTemp']//following::option["+cc+"]")).getText();
				/*
				 * BaseTest.select_index(driver.findElement(By.id("casteDivision")), j);
  		...
  		//////////////////////
  			...
  			Thread.sleep(3000);
  		   		...
  		   		String search_divison = driver.findElement(By.xpath("//select[@id='denominationTemp']//following::option["+cc+"]")).getText();
  		   			Thread.sleep(2000);
  		   		driver.findElement(By.xpath("//select[@id='denominationTemp']//following::option["+cc+"]")).click();
  		   		acc.doubleClick(driver.findElement(By.xpath("//select[@id='denominationTemp']//following::option["+cc+"]"))).build().perform();
  		   		}
  		   			Thread.sleep(3000);
  		   			int CommonDivision_Count = BaseTest.getRowCount("Common Division");
  		   			System.out.println("Row Count : "+CommonDivision_Count);
   ...
   //////////////////////////////////////////////////////////////////////			
   			...
   			Thread.sleep(3000);
   		   	...
   		   	//	}
   		   			...
   		   			Thread.sleep(3000);
   		   			driver.findElement(By.xpath("//*[@id=\"lp-container\"]/div/div/center/div[1]/div[2]/div/div[1]/div[1]/div[2]/a")).click();
   		   		...
   		   		//ViewProfile_POM vv = new ViewProfile_POM(driver);
   		   			...
   		   			Thread.sleep(2000);
   		   			String denominations = driver.findElement(By.xpath("//span[contains(text(),'Denomination')]//following::span[2]")).getText();
   		   			
   		   			
   		   			
   		   		Thread.sleep(2000);
		   			String Divisionss = driver.findElement(By.xpath("//span[contains(text(),'Division')]//following::span[2]")).getText();
